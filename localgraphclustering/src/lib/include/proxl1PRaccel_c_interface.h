...
extern "C"
{
    ...
    uint32_t proxl1PRaccel32(uint32_t n, uint32_t* ai, uint32_t* aj, double* a, double alpha,
                             ...
                             double epsilon, double* grad, double* p, double* y, uint32_t maxiter, uint32_t offset, double max_time, bool normalized_objective);
    ...
    int64_t proxl1PRaccel64(int64_t n, int64_t* ai, int64_t* aj, double* a, double alpha,
                            ...
                            double epsilon, double* grad, double* p, double* y, int64_t maxiter, int64_t offset, double max_time, bool normalized_objective);
