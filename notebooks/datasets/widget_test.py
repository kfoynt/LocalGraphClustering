...
g = graph_class_local.GraphLocal('ASTRAL-small-sized-mammoth-sims-geq-2_2.graphml','graphml',' ')
...
ld_coord = np.loadtxt('ASTRAL-small-sized-mammoth-sims-geq-2_2.xy', dtype = 'str')
