...
for rr in all_clusters:
    ...
    for node in nodes[ct_outer]:
        ...
        for a in a_list:
            ...
            output_pr_clustering = approximate_PageRank(g,ref_node,method = "l1reg-rand", epsilon=1.0e-4, rho=rho, alpha=a, cpp = True, normalize=True,normalized_objective=True,iterations=10000000)
            number_experiments += 1
